// ITEM Made by player(Ğşºú:rayyifan44) /data/item/r/rayyifan44-tiew.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Jan  6 20:24:15 2019
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("ÌúÍó[2;37;0m", ({ "tiew" }));
	set_weight(2500);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[37mÉÏ¹Åº®Ìú[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºĞşºú(rayyifan44)
");
	set("value", 1500000);
	set("point", 37);
	set("material", "steel");
	set("wear_msg", "[33m$N[33m×°±¸ÌúÍó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁËÌúÍó[2;37;0m[33m¡£[2;37;0m\n");
