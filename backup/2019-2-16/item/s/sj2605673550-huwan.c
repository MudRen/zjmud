// ITEM Made by player(ÎèÇàÒÂ:sj2605673550) /data/item/s/sj2605673550-huwan.c
...
void create()
{
	set_name("[1;31m»¤Íó[2;37;0m", ({ "huwan" }));
	set_weight(2500);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[37mÉÏ¹Åº®Ìú[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºÎèÇàÒÂ(sj2605673550)
");
	set("value", 1500000);
	set("point", 37);
	set("material", "steel");
	set("wear_msg", "[33m$N[33m×°±¸[1;31m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;31m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
